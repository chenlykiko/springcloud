...
public class CircleBreakerController
{
    ...
    //@SentinelResource(value = "fallback" ,blockHandler = "handlerFallback") // blockHandler负责限流降级等异常
    @SentinelResource(value = "fallback" ,fallback = "handlerFallback", blockHandler = "blockHandler",
    exceptionsToIgnore = {IllegalArgumentException.class}) //exceptionsToIgnore配置的异常不处理
